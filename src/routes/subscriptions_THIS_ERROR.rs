...
// pub enum SubscribeError { //todo no longer define manually
...
// impl std::fmt::Display for ValidationError { //todo can't use this for strings anymore
...
// //we're also expanding display to be more nuanced/detailed than just "failed to create a subscriber"
// impl std::fmt::Display for SubscribeError { //todo no longer define manually
//     fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
//         match self {
...
// impl std::error::Error for SubscribeError { //todo no longer define manually
//     fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
//         match self {
...
// impl From<StoreTokenError> for SubscribeError { //todo no longer define manually
